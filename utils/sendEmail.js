    ...
    const msg = {
      ...
      html: `
        ...
        <body style="margin:0; padding:0; background:#dbeafe;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#dbeafe; padding:40px 20px;">
            <tr><td align="center">
              ...
              ">
                  ...
                  <td style="background:#1d4ed8; padding:22px 28px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="vertical-align:middle; font-weight:700; font-size:18px; color:#ffffff; letter-spacing:2px; text-transform:uppercase; font-family:'Barlow',Arial,sans-serif;">
                          FACTORY<span style="color:#93c5fd;">HUB</span>
                        </td>
                        <td align="right" style="vertical-align:middle;">
                          <span style="background:rgba(255,255,255,0.12); border:1px solid rgba(255,255,255,0.2); border-radius:20px; padding:4px 12px; font-family:'Share Tech Mono',monospace; font-size:10px; color:#bfdbfe; letter-spacing:1px;">
                            &#9679; SECURE
                          </span>
                        </td>
                      </tr>
                ...
                <tr>
                  <td style="padding:32px 28px; background:#ffffff;">
                    ...
                    <p style="margin:0 0 4px; font-size:21px; font-weight:600; color:#1e3a8a; line-height:1.3;">
                      Your One-Time<br>Access Code
                    </p>
                    <p style="margin:0 0 26px; font-size:13px; color:#6b7280;">
                      ...
                      <tr>
                        <td style="padding:22px 24px;">
                          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:14px;">
                            <tr>
                              <td style="font-family:'Share Tech Mono',monospace; font-size:10px; color:#2563eb; letter-spacing:3px;">
                                &#9654; ONE-TIME PASSCODE
                              </td>
                              <td align="right" style="font-family:'Share Tech Mono',monospace; font-size:10px; color:#22c55e; letter-spacing:1px;">
                                &#9679; EXPIRES IN 10:00
                              </td>
                            </tr>
                          </table>
                          <p style="margin:0; font-family:'Share Tech Mono',monospace; font-size:38px; letter-spacing:8px; color:#1e3a8a;">
                            ${formatted}
                          </p>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td style="padding:12px 14px;">
                          <table cellpadding="0" cellspacing="0">
                            <tr>
                              <td style="vertical-align:top; padding-right:8px; font-family:'Share Tech Mono',monospace; font-size:11px; color:#16a34a;">[✓]</td>
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="vertical-align:top; padding-right:10px; font-family:'Share Tech Mono',monospace; font-size:12px; color:#3b82f6;">[!]</td>
                ...
                <tr>
                  <td style="background:#eff6ff; border-top:1px solid #dbeafe; padding:14px 28px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="font-family:'Share Tech Mono',monospace; font-size:10px; color:#93c5fd; letter-spacing:2px;">
                          FACTORYHUB // SECURE COMMS
                        </td>
                        <td align="right">
                          <span style="background:#ffffff; border:1px solid #bbf7d0; border-radius:20px; padding:4px 10px; font-family:'Share Tech Mono',monospace; font-size:10px; color:#16a34a; letter-spacing:1px;">
                            &#9679; VERIFIED SENDER
                          </span>
                        </td>
                      </tr>
